...
<body class="bg-[#EADDCF]">
    ...
    <div class="pt-6 pb-[100px] px-8 md:px-20 lg:px-[120px] bg-[#FFFFFE] flex flex-col items-center min-h-screen">
        <p class="w-full text-right text-[18px] text-[#716040]">Welcome back, $user->name</p>
        ...
        {{-- Todo List --}}
        <div
            class="mt-2 px-[30px] py-[70px] w-full bg-[#EADDCF] text-[#716040] rounded-tl-[10px] rounded-tr-[100px] rounded-bl-[100px] rounded-br-[10px] flex flex-col gap-[30px]">

            {{-- List item --}}
            <div class="px-6 py-2 bg-[#FFFFFE] text-[#716040] rounded-[5px] md:flex md:justify-between md:items-center shadow">
                <div class="flex items-center">
                    <div><svg width="30" height="31" viewBox="0 0 30 31" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.5" y="1" width="29" height="29" fill="#FFFFFE" stroke="black" />
                        </svg>
                    </div>
                    <div class="mx-6">
            ...
            <div class="px-6 py-2 bg-[#FFFFFE] text-[#716040] rounded-[5px] md:flex md:justify-between md:items-center shadow">
                <div class="flex items-center">
                    <div><svg width="30" height="31" viewBox="0 0 30 31" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.5" y="1" width="29" height="29" fill="#FFFFFE" stroke="black" />
                            <path d="M6 16L14 24.5L25 6.5" stroke="black" stroke-width="2" />
                        </svg>
                    </div>
                    <div class="mx-6">
                        <h1 class="text-lg line-through">Title</h1>
                        <p class="text-sm">Date</p>
                    </div>
                </div>
